...
const Navbar = ({
  ...
  const displayTitle = currentSpaceProfile.spaceName || settings.blogTitle || 'nknock';
  const displaySubtitle = currentSpaceProfile.spaceSubtitle || settings.blogSubtitle || 'nknock';
      ...
      <div className="logo-nav-section">
        ...
        <div className="category-nav-grid">
          ...
          <div className="nav-grid-item" data-category="書桌">
            ...
            <div className="nav-grid-subs">
              <a href="#" className="nav-grid-child" onClick={(e) => { e.preventDefault(); handleCategoryNav('書桌', '寵物'); }}>寵物</a>
              <a href="#" className="nav-grid-child" onClick={(e) => { e.preventDefault(); handleCategoryNav('書桌', '手做'); }}>手做</a>
              <a href="#" className="nav-grid-child" onClick={(e) => { e.preventDefault(); handleCategoryNav('書桌', '飲食'); }}>飲食</a>
            </div>
          </div>
