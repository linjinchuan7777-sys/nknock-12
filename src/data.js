...
export const DEFAULT_POSTS = [
  {
    ...
    content: `今天是個晴朗的週末，我決定出門走走，造訪了心心念念 of 向日葵花海。<br><br>
  ...
  },
  {
    ...
    衣服不只是底層遮蔽，更是我們展現自我、表達當下心情的方式。這件洋裝帶給我的，是輕盈、自由且自信的感受。我已經把它收進了衣櫃最顯眼的位置，準備穿著它度過這整個美麗的夏天。`,
    category: "衣櫃",
    subcategory: "衣服",
...
export const DEFAULT_FRIENDS = [
  {
    ...
    posts: [
      ...
      },
      {
        ...
        content: "深夜一點半，房間裡只剩喇叭發出的幽暗小號聲。<br><br>有時候我常想，我們做音樂、收藏音樂，到底是在尋找共鳴，還是在享受孤適？每當我戴上耳機，整個世界都安靜了，只剩下旋律在腦海中勾勒出一個安全的避難所。很多時候，言語無法傳達的情感，音符卻能在一瞬間擊中內心。謝謝你在我最低潮的時候，願意陪我默默坐在這聽完一整張唱片。這篇文章只寫給我最親近的朋友，感謝你們的陪伴。",
        category: "消息",
        subcategory: "情感",
    ...
    posts: [
      {
        ...
        content: "今天在收容所值班，遇到了一隻剛被救援送來的三花貓。<br><br>一看到我走近，不但沒有躲，反而主動走到籠子邊用頭蹭我的手，嘴裡還發出很大聲的『咕嚕咕嚕』聲。我把牠抱起來，牠就整隻貓軟綿綿地趴在我肩膀上，簡集是天使！<br><br>我們叫牠糰子，希望有人能快點帶牠回家，給牠一個溫慢的避難所。牠一定會是一個超級貼心的家人。",
        category: "消息",
        subcategory: "話題",
        image: "https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?w=800",
